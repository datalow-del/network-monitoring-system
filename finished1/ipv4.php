...
<head>
  <title>Network Monitorer / IPV4</title>
...
<body>
  <div id="header" class="container">
    <div id="logo">
      <h1>Network Monitorer / IPV4</h1>
 
    </div>
    
    <div id="menu">
      <ul>
        <li class="current_page_item"><a href="index.php" accesskey="1" title="">
        ...
        <li><a href="ipv4refresh.php" accesskey="4" title="">
